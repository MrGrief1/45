...
const AppIconFallbacks = {
    cache: {
        whatsapp: 'data:image/svg+xml;base64,',
...
const AuxPanelManager = {
    ...
    loadAppsLibrary: async function() {
        try {
            ...
            if (content) {
                ...
                loadingElement.className = 'apps-library-loading';
                loadingElement.innerHTML = `
                    <div class="apps-library-spinner"></div>
                    <span>${LocalizationRenderer.t('apps_library_loading')}</span>
                `;
            ...
            if (content) {
                ...
                const finalizeLoadingState = () => {
                    if (loadingElement && loadingElement.parentNode === content) {
    ...
    categorizeApps: function(apps) {
        ...
        const shouldFilterSystemApps = AppState.settings.showAllApps !== true;
